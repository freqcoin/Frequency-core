...
class RawTransactionsTest(FrequencyTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid frequency address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid frequency address" in e.error['message'])

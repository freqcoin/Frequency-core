...
from test_framework.frequency_node import FrequencyTestNode
...
class Frequency_ColdStakingTest(FrequencyTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(FrequencyTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 FRQ from the pot)
...
if __name__ == '__main__':
    Frequency_ColdStakingTest().main()

...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/frequency-cli.cpp \
           src/frequency-tx.cpp \
           src/frequency.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/frequency.qrc src/qt/frequency_locale.qrc

TRANSLATIONS += src/qt/locale/frequency_bg.ts \
                src/qt/locale/frequency_de.ts \
                src/qt/locale/frequency_en.ts \
                src/qt/locale/frequency_es.ts \
                src/qt/locale/frequency_fi.ts \
                src/qt/locale/frequency_fr.ts \
                src/qt/locale/frequency_it.ts \
                src/qt/locale/frequency_ja.ts \
                src/qt/locale/frequency_pl.ts \
                src/qt/locale/frequency_pt.ts \
                src/qt/locale/frequency_ru.ts \
                src/qt/locale/frequency_sk.ts \
                src/qt/locale/frequency_sv.ts \
                src/qt/locale/frequency_vi.ts \
                src/qt/locale/frequency_zh_CN.ts \
                src/qt/locale/frequency_zh_TW.ts

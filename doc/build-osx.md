...
1. Clone the Frequency source code:
...
Frequency is now available at `./src/frequencyd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/frequency"

    touch "/Users/${USER}/Library/Application Support/frequency/frequency.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/frequency/frequency.conf"

The first time you run frequencyd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/frequency/debug.log

Other commands:
-------

    ./src/frequencyd -daemon # Starts The Frequency daemon.
    ./src/frequency-cli --help # Outputs a list of command-line options.
    ./src/frequency-cli help # Outputs a list of RPC commands when the daemon is running.

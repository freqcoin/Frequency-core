...
This document provides guidelines for internationalization of the Frequency Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Frequency network</source>
        <translation>
            <numerusform>%n active connection to Frequency network</numerusform>
            <numerusform>%n active connections to Frequency network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `frequency_en.ts` remains unchanged.

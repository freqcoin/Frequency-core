...
The build script we'll be using is contained in the Frequency github repository ([contrib/gitian-build.py](https://github.com/forking-altcoins/frequency/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Frequency repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/forking-altcoins/Frequency/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, frequency-detached-sigs, and frequency GitHub repos.

/* src/config/frequency-config.h.  Generated from frequency-config.h.in by configure.  */
/* src/config/frequency-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/forking-altcoins/frequency/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Frequency Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Frequency Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "frequency"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://frequency.org/"

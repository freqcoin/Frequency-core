 ...
 * Frequency system. There are three: the main network on which people trade goods
...
public:
    ...
    int FrequencyBadBlockTime() const { return nFrequencyBadBlockTime; }
    int FrequencyBadBlocknBits() const { return nFrequencyBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nFrequencyBadBlockTime;
    unsigned int nFrequencyBadBlocknBits;

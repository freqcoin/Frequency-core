...
/** 
    ...
    ****Note - for Frequency we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of frequency coming in to a transaction

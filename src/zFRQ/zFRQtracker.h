...
#ifndef Frequency_ZFRQTRACKER_H
#define Frequency_ZFRQTRACKER_H
...
public:
    CzFRQTracker(std::string strWalletFile);
    ~CzFRQTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFRQWallet* zFRQWallet = NULL);

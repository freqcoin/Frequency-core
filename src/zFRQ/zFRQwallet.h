// Copyright (c) 2017-2018 The Frequency developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Frequency_ZFRQWALLET_H
#define Frequency_ZFRQWALLET_H
...
public:
    CzFRQWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZFRQ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFRQ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

...
// Copyright (c) 2015-2019 The Frequency developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000078b7e2619b67ad06a65fb21140e5ee73ef8a0c8a43a7e48fce7441e1226"));  //launch
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1668124800, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04e39f3aeea0ff37c653c37430f719eefa661a922fe86d3bdbf1d4a92c0a01db48f6ccd9a139570f13755fd295142ffc1049952fd892cd330da2c43683ca7c895c");
        nDefaultPort = 25256;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Frequency starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 500;
        nFrequencyBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nFrequencyBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1668124800; //!> Sporks signed after Monday, August 26, 2019 11:00:00 PM GMT must use the new spork key
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Frequency made with love in the left side of pain in heart";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041ef92afbbf801ac2796bceee7bf05f3877682622df67f8af6b15e2d945116cdb9e3b395977dc54543f7356f4ffff38f8bde0c76a6d292e24f02cec35dc398a21") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1668124800;
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 12765117;
		


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000078b7e2619b67ad06a65fb21140e5ee73ef8a0c8a43a7e48fce7441e1226"));
        assert(genesis.hashMerkleRoot == uint256("0xc8f60b235346877fd96e43982e446de0e4e1628c0ec1025006e315c9987292b0"));


        vSeeds.push_back(CDNSSeedData("185.125.171.35", "185.125.171.35"));
		vSeeds.push_back(CDNSSeedData("168.119.49.65", "168.119.49.65"));
		vSeeds.push_back(CDNSSeedData("167.235.63.155", "167.235.63.155"));
		vSeeds.push_back(CDNSSeedData("65.21.179.7", "65.21.179.7"));
        ...
        strSporkPubKey = "04332e7626a54ec767d7c413b98c280d170a73a93dfe43249ecca7e8c1cdd52475945c911ea1c2c0b9055efe78d2c21ac3048e0a100c6d9e1fcf9802ba86878904";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zFRQ to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("0435fe70b52e35223d58419ea3021a90e12161963a7205d6e4fdf430fc6c02f7c89a45d83b7317a75575afa0d49019ab97eaba82ccbf148f534cd6bf63391a00b0");
        nDefaultPort = 19340;
        ...
        nFrequencyBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nFrequencyBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
		...
		vSeeds.push_back(CDNSSeedData("185.125.168.112", "185.125.168.112"));
		

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 48); // Testnet frequency addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 135);  // Testnet frequency script addresses start with 'w'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125);     // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet frequency BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet frequency BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet frequency BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkPubKey = "0494745679b030a384bdc713fe99a3c9672bbd249a49d07db7a959015b283b0ab9646ac6e7e96d479c76bf1f2ad90321e19f797958c96fe724181fa5b7cab9d7fc";
        ...
        strObfuscationPoolDummyAddress = "LW5mnPduovqtohyQXYmcVwA7LH2TRSaCh5";
        nStartMasternodePayments = 1668124800; //Fri, 09 Jan 2015 21:05:58 GMT
...
public:
    CRegTestParams()
    {
        ...
        //genesis.nTime = 1668124800;
        //genesis.nNonce = 3462969;

        hashGenesisBlock = genesis.GetHash();
        //assert(hashGenesisBlock == uint256("0x00000380fb4661482d1f003b5ecbefe58aed6a5a15f256e78414e480428fbe58"));

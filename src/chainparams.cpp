...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000fee408a454885080b77f66361338faa231fdef630c3b364b7beb46edc1b"));  //launch
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1675907443, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04b165787683d90e47a9f0fc87f07f1ba981428ac4a8329d2a81cf8dd6a2c8e1a6e166bc7dcda9b80ca13d1f13d97e36c5e233d0c423fbc37f50a0088cfcc78fd1");
        nDefaultPort = 25256;
        ...
        nEnforceNewSporkKey = 1675907443; //!> Sporks signed after Monday, August 26, 2019 11:00:00 PM GMT must use the new spork key
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Wednesday, February 8, 2023 16:03:31 - Frequency chain starts";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e4907acf20218e6a31d59e22a0258ebe3a0e4d3076dce0a46f0279008a186e5d2d1b3c32b5baab5921079e594615bca16dd9f935586731adf3f4b41449efcbd2") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1675907443;
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 14732392;
		
		
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000fee408a454885080b77f66361338faa231fdef630c3b364b7beb46edc1b"));
        assert(genesis.hashMerkleRoot == uint256("0xaff4010927166943001b789ed7c8e4ed7957d89d2854bdf0768b8fdb98bccc12"));


        vSeeds.push_back(CDNSSeedData("65.108.56.165", "65.108.56.165"));
		vSeeds.push_back(CDNSSeedData("78.47.232.46", "78.47.232.46"));
		vSeeds.push_back(CDNSSeedData("116.203.217.204", "116.203.217.204"));
        ...
        strSporkPubKey = "045ef5fe496a3b4dc5322b061d8678aded7e2c30970643f0da7bc0f1e085936421db72dc13b5ed58102bc746072c2891ddbace61b62153e0167505019f872e6482";
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04551c31b8f697991a55f334506ed3b81fcef45a40d8252df59f2c8ef7995fce1c9a2ad03827f197a38bed01af0e0ea9f5fcc0024cabb23bab1cedb718fdfef0d9");
        nDefaultPort = 19340;
        ...
        strSporkPubKey = "0492d8401220c1bce77c26924379e11a547d1ba556309313150117099f2217437b954556112fa584515a57c12fc965dae9bc321f4d839ed19d7a82278c40b51d10";
        ...
        strObfuscationPoolDummyAddress = "LW5mnPduovqtohyQXYmcVwA7LH2TRSaCh5";
        nStartMasternodePayments = 1675907443; //Fri, 09 Jan 2015 21:05:58 GMT

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Frequency Core frequency-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  frequency-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded frequency transaction") + "\n" +
                               "  frequency-tx [options] -create [commands]   " + _("Create hex-encoded frequency transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded frequency transaction

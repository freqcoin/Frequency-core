...
#include "qt/frequency/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/frequency/lockunlock.h"
#include "qt/frequency/qtutils.h"
#include "qt/frequency/receivedialog.h"
...
TopBar::TopBar(FrequencyGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Frequency")
    updateDisplayUnit();

...
#include "qt/frequency/forms/ui_addresseswidget.h"
#include "qt/frequency/addresslabelrow.h"
#include "qt/frequency/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(FrequencyGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Frequency address"));

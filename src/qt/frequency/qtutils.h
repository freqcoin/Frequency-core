...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, FrequencyGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, FrequencyGUI *gui, double posX = 3);

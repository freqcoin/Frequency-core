...
#include "qt/frequency/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/frequency/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(FrequencyGUI* _window, QWidget *parent) :

...
#include "qt/frequency/settings/settingsnetworkwidget.h"
#include "qt/frequency/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/frequency/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(FrequencyGUI* _window, QWidget *parent) :

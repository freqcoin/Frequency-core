...
#include "qt/frequency/settings/settingssignmessagewidgets.h"
#include "qt/frequency/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(FrequencyGUI* _window, QWidget *parent) :

...
#include "qt/frequency/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/frequency/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(FrequencyGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to FrequencyGUI::handleRestart()

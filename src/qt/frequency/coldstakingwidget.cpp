...
#include "qt/frequency/forms/ui_coldstakingwidget.h"
#include "qt/frequency/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/frequency/requestdialog.h"
#include "qt/frequency/tooltipmenu.h"
#include "qt/frequency/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(FrequencyGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your FRQs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept FRQ delegation / Delegate FRQ"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select FRQ outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 FRQ" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}

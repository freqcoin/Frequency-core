...
#include "qt/frequency/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(FrequencyGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-frequency");

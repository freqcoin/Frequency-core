...
#ifndef Frequency_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Frequency_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Frequency_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H

...
#include "qt/frequency/coincontrolpivwidget.h"
#include "qt/frequency/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select FRQ Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("FRQ");
    ...
    ui->labelValueAfter->setText("0.00 FRQ");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 FRQ");
    ui->labelValueFee->setText("0.00 FRQ");

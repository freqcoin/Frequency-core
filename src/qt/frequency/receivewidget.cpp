...
#include "qt/frequency/forms/ui_receivewidget.h"
...
#include "qt/frequency/addressholder.h"
...
ReceiveWidget::ReceiveWidget(FrequencyGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive FRQ."));

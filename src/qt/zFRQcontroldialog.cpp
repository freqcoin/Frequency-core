// Copyright (c) 2017-2020 The Frequency developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "zFRQcontroldialog.h"
#include "ui_zFRQcontroldialog.h"
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zFRQ Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zFRQ.";
            else if (!mint.isSeedCorrect)
                strReason = "The zFRQ seed used to mint this zFRQ is not the same as currently hold in the wallet";
            else

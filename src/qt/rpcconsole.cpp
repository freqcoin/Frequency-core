                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFRQPathCustom = GetArg("-zFRQbackuppath", "");
    ...
    if(!strzFRQPathCustom.empty()) {
        ui->wallet_customzFRQbackuppath->setText(QString::fromStdString(strzFRQPathCustom));
        ui->wallet_customzFRQbackuppath_label->setVisible(true);
        ui->wallet_customzFRQbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFRQPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Frequency RPC console.") + "<br>" +

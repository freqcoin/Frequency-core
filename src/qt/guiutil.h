...
/** Utility functions used by the Frequency Qt UI.
 */
namespace GUIUtil
{
...
// Render Frequency addresses in monospace font
...
// Parse "frequency:" URI into recipient object, return true on successful parsing

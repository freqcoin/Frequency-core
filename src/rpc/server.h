...
/**
 * Frequency RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzFRQseed(const UniValue& params, bool fHelp);
extern UniValue getzFRQseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzFRQ(const UniValue& params, bool fHelp);
extern UniValue dzFRQstate(const UniValue& params, bool fHelp);

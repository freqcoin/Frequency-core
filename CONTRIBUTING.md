Contributing to Frequency Core
============================

The Frequency Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/forking-altcoins/frequency/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Frequency Core project, and is not to be
confused with overall Frequency Network Protocol consensus changes.

Whether a pull request is merged into Frequency Core rests with the project merge
...
Patches that change Frequency consensus rules are considerably more involved than
...
Where a patchset proposes to change the Frequency consensus, it must have been
...
The project leader is the release manager for each Frequency Core release.
